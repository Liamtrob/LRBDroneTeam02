...
if __name__ == "__main__":
    ...
    params = {'floor':40, 'ceiling':200, 'm_type':m_type}
    my_robomaster = Tello()
    drone = HighFlyers(my_robomaster, params)
    BAR_ground = drone.get_barometer()
    print('BAR GROUND IS', BAR_ground)
    drone.takeoff()
    print('drone is currently at IRS ', drone.drone.get_height(), 'CM after takeoff')
    print('drone is currently at BAR ', (drone.drone.get_barometer() - BAR_ground), 'CM after takeoff')
    time.sleep(5)
    drone.go_to_floor(BAR_ground)
    print('at floor')
    print('drone is currently at IRS ', drone.drone.get_height(), 'CM at floor')
    print('drone is currently at BAR ', (drone.drone.get_barometer() - BAR_ground), 'CM at floor')
    time.sleep(5)
    drone.go_to_ceiling(BAR_ground)
    print('at ceiling')
    print('drone is currently at IRS ', drone.drone.get_height(), 'CM at ceiling')
    print('drone is currently at BAR ', (drone.drone.get_barometer() - BAR_ground), 'CM at ceiling')
    time.sleep(5)
    drone.go_to_floor(BAR_ground) 
    print('drone is currently at IRS ', drone.drone.get_height(), 'CM at floor')
    print('drone is currently at BAR ', (drone.drone.get_barometer() - BAR_ground), 'CM at floor')
    print('at floor going to land')
    time.sleep(5)
    drone.land()
